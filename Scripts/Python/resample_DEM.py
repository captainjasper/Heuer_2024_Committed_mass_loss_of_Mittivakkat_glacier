...
moved = driver.CreateCopy("./Arctic_DEM/DEM_full_extent.tif", ds2)
...
dem_in = "./Arctic_DEM/DEM_full_extent.tif"
...
os.remove("./Arctic_DEM/DEM_reproj.tif")
os.remove("./Arctic_DEM/merged_DEM.tif")
os.remove("./Arctic_DEM/DEM_reproj.tif.aux.xml")
...
with rasterio.open("./Arctic_DEM/14_44_1_1_2m_v4.1/14_44_1_1_2m_v4.1_browse.tif") as src:
    ...
    with rasterio.open("./Arctic_DEM/14_44_1_1_2m_v4.1/14_44_1_1_2m_v4.1_browse_resample.tif",
                       "w", **kwargs) as dst:
